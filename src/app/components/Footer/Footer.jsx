    ...
    <>
      <div className="footer" id="footer">
        <div className="w-full flex flex-col bg-[--secondary-color] py-10 px-6">
          <div
            className="font-bold sm:text-5xl text-3xl cursor-pointer flex justify-center items-center mb-10 
      text-[--primary-text-color-black]"
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center bg-[--secondary-color] flex-wrap text-[--secondary-text-color]">
            ...
            <p className="mx-1 hover:text-[--primary-text-color-black] duration-500 cursor-pointer text-center">
              @2024 Inerres - <Link href={"https://muhammadkaifnazeer.netlify.app/"}  target="__blank" className="hover:underline">Muhammad Kaif Nazeer.</Link>  All Rights Reserved.
            </p>
            <p className="mx-1 hover:text-[--primary-text-color-black] duration-500 hover:underline cursor-pointer">
              Privacy Policy
            </p>
